...
public enum ParticleEffect {
	 ...
	 *             If the particle effect requires additional data
	 * @throws IllegalArgumentException
	 *             If the particle effect is not directional or if it requires water and none is at the center location
	...
	public static final class ParticlePacket {
		 ...
		 *            Center location of the effect
		 * @param range
		 *            Range in which players will receive the packet (Maximum range for particles is usually 16, but it can differ for some types)
		 * @throws IllegalArgumentException
